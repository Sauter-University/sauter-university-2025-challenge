...
class ReservoirVolume(BaseModel):
    """
    Represents the structure of a single reservoir data point.
    ...
    reservoir_name: str = Field(alias="nom_reservatorio")
    recorded_date: date = Field(alias="ear_data")
    volume_percent_useful: float = Field(alias="ear_reservatorio_percentual")
